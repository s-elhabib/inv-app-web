...
BEGIN
  ...
  -- 2. Products
  -- Removed sellingPrice column, only using price
  INSERT INTO products (id, name, price, stock, category_id, created_at, image)
  VALUES 
    (gen_random_uuid(), 'Smartphone', 2500, 10, electronics_id, NOW(), 'https://placehold.co/400x300?text=Smartphone'),
    (gen_random_uuid(), 'T-shirt', 100, 20, clothing_id, NOW(), 'https://placehold.co/400x300?text=T-shirt'),
    (gen_random_uuid(), 'Chocolate Bar', 15, 50, food_id, NOW(), 'https://placehold.co/400x300?text=Chocolate'),
    (gen_random_uuid(), 'Desk Lamp', 200, 15, home_goods_id, NOW(), 'https://placehold.co/400x300?text=Lamp'),
    (gen_random_uuid(), 'Notebook', 30, 30, office_supplies_id, NOW(), 'https://placehold.co/400x300?text=Notebook');
END $$;
...
BEGIN
  ...
  -- Create orders
  INSERT INTO orders (id, client_id, total, created_at)
  VALUES 
    (gen_random_uuid(), client_id1, 2500, NOW() - INTERVAL '5 days'),
    (gen_random_uuid(), client_id2, 300, NOW() - INTERVAL '4 days'),
    (gen_random_uuid(), client_id3, 45, NOW() - INTERVAL '3 days'),
    (gen_random_uuid(), client_id4, 400, NOW() - INTERVAL '2 days'),
    (gen_random_uuid(), client_id5, 90, NOW() - INTERVAL '1 day');
