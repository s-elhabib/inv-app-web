...
BEGIN
  ...
  -- 2. Products
  INSERT INTO products (id, name, price, stock, category_id, sellingPrice, created_at)
  VALUES 
    (gen_random_uuid(), 'Smartphone', 2000, 10, electronics_id, 2500, NOW()),
    (gen_random_uuid(), 'T-shirt', 50, 20, clothing_id, 100, NOW()),
    (gen_random_uuid(), 'Chocolate Bar', 10, 50, food_id, 15, NOW()),
    (gen_random_uuid(), 'Desk Lamp', 150, 15, home_goods_id, 200, NOW()),
    (gen_random_uuid(), 'Notebook', 20, 30, office_supplies_id, 30, NOW());
END $$;
