...
-- 3. Clients
INSERT INTO clients (id, name, phone, email, address, status, image, created_at, updated_at, deleted_at)
VALUES 
  (gen_random_uuid(), 'Ahmed Hassan', '0612345678', 'ahmed@example.com', 'Casablanca, Morocco', 'active', 'https://placehold.co/400x300?text=Ahmed', NOW(), NOW(), NULL),
  (gen_random_uuid(), 'Fatima Zahra', '0623456789', 'fatima@example.com', 'Rabat, Morocco', 'active', 'https://placehold.co/400x300?text=Fatima', NOW(), NOW(), NULL),
  (gen_random_uuid(), 'Mohammed Ali', '0634567890', 'mohammed@example.com', 'Marrakech, Morocco', 'active', 'https://placehold.co/400x300?text=Mohammed', NOW(), NOW(), NULL),
  (gen_random_uuid(), 'Aisha Benali', '0645678901', 'aisha@example.com', 'Tangier, Morocco', 'active', 'https://placehold.co/400x300?text=Aisha', NOW(), NOW(), NULL),
  (gen_random_uuid(), 'Youssef Mansour', '0656789012', 'youssef@example.com', 'Agadir, Morocco', 'active', 'https://placehold.co/400x300?text=Youssef', NOW(), NOW(), NULL);

-- 4. Suppliers
INSERT INTO suppliers (id, name, contact_person, phone, email, address, created_at, updated_at)
VALUES 
  (gen_random_uuid(), 'Global Electronics', 'Hassan Alami', '0512345678', 'global@example.com', 'Casablanca Industrial Zone', NOW(), NOW()),
  (gen_random_uuid(), 'Fashion Wholesale', 'Nadia Benkiran', '0523456789', 'fashion@example.com', 'Marrakech Commercial Center', NOW(), NOW()),
  (gen_random_uuid(), 'Food Distributors', 'Karim Tazi', '0534567890', 'food@example.com', 'Rabat Business District', NOW(), NOW()),
  (gen_random_uuid(), 'Home Essentials', 'Samira Idrissi', '0545678901', 'home@example.com', 'Tangier Port Area', NOW(), NOW()),
  (gen_random_uuid(), 'Office Pro Supplies', 'Omar Benjelloun', '0556789012', 'office@example.com', 'Agadir Commercial Zone', NOW(), NOW());
...
BEGIN
  ...
  -- 5. Supplier Orders
  INSERT INTO supplier_orders (id, supplier_id, invoice_number, invoice_image, total_amount, status, notes, created_at, updated_at)
  VALUES 
    (gen_random_uuid(), electronics_supplier_id, 'INV-001', 'https://placehold.co/400x300?text=Invoice1', 10000, 'completed', 'Electronics order received in full', NOW() - INTERVAL '30 days', NOW() - INTERVAL '30 days'),
    (gen_random_uuid(), clothing_supplier_id, 'INV-002', 'https://placehold.co/400x300?text=Invoice2', 5000, 'completed', 'Clothing order received in full', NOW() - INTERVAL '25 days', NOW() - INTERVAL '25 days'),
    (gen_random_uuid(), food_supplier_id, 'INV-003', 'https://placehold.co/400x300?text=Invoice3', 2000, 'completed', 'Food order received in full', NOW() - INTERVAL '20 days', NOW() - INTERVAL '20 days'),
    (gen_random_uuid(), home_supplier_id, 'INV-004', 'https://placehold.co/400x300?text=Invoice4', 3000, 'pending', 'Home goods order in transit', NOW() - INTERVAL '15 days', NOW() - INTERVAL '15 days'),
    (gen_random_uuid(), office_supplier_id, 'INV-005', 'https://placehold.co/400x300?text=Invoice5', 1500, 'pending', 'Office supplies order processing', NOW() - INTERVAL '10 days', NOW() - INTERVAL '10 days');
END $$;
...
BEGIN
  ...
  -- Create orders - using total_amount and status columns from the schema
  INSERT INTO orders (id, client_id, total_amount, status, created_at, updated_at, deleted_at, invoice_number)
  VALUES 
    (gen_random_uuid(), client_id1, 2500, 'completed', NOW() - INTERVAL '5 days', NOW() - INTERVAL '5 days', NULL, '01'),
    (gen_random_uuid(), client_id2, 300, 'completed', NOW() - INTERVAL '4 days', NOW() - INTERVAL '4 days', NULL, '02'),
    (gen_random_uuid(), client_id3, 45, 'completed', NOW() - INTERVAL '3 days', NOW() - INTERVAL '3 days', NULL, '03'),
    (gen_random_uuid(), client_id4, 400, 'pending', NOW() - INTERVAL '2 days', NOW() - INTERVAL '2 days', NULL, '04'),
    (gen_random_uuid(), client_id5, 90, 'pending', NOW() - INTERVAL '1 day', NOW() - INTERVAL '1 day', NULL, '05');
  ...
  -- Create sales
  INSERT INTO sales (id, product_id, client_id, amount, quantity, created_at, order_id, unit_price)
  VALUES 
    (gen_random_uuid(), product_id1, client_id1, 2500, 1, NOW() - INTERVAL '5 days', order_id1, 2500),
    (gen_random_uuid(), product_id2, client_id2, 300, 3, NOW() - INTERVAL '4 days', order_id2, 100),
    (gen_random_uuid(), product_id3, client_id3, 45, 3, NOW() - INTERVAL '3 days', order_id3, 15),
    (gen_random_uuid(), product_id4, client_id4, 400, 2, NOW() - INTERVAL '2 days', order_id4, 200),
    (gen_random_uuid(), product_id5, client_id5, 90, 3, NOW() - INTERVAL '1 day', order_id5, 30);
END $$;
