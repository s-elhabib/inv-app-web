...
BEGIN
  ...
  -- 2. Products
  -- Removed sellingPrice column since it doesn't exist in your schema
  INSERT INTO products (id, name, price, stock, category_id, created_at)
  VALUES 
    (gen_random_uuid(), 'Smartphone', 2500, 10, electronics_id, NOW()),
    (gen_random_uuid(), 'T-shirt', 100, 20, clothing_id, NOW()),
    (gen_random_uuid(), 'Chocolate Bar', 15, 50, food_id, NOW()),
    (gen_random_uuid(), 'Desk Lamp', 200, 15, home_goods_id, NOW()),
    (gen_random_uuid(), 'Notebook', 30, 30, office_supplies_id, NOW());
END $$;
